...
public class PostDao {
    ...
    public List<Post> getPostsByPage(int offset, int pageSize) {
        List<Post> posts = new ArrayList<>();
    ...
    public List<Post> getPostsByPageAndCategory(int offset, int pageSize, String category) {
        List<Post> posts = new ArrayList<>();
    ...
    public List<Post> getPostsBySearch(int offset, int pageSize, String keyword) {
        List<Post> list = new ArrayList<>();
