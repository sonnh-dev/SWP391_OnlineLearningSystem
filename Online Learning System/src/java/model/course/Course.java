...
public class Course {
    ...
    public Course(int courseID, String title, String category, int lectures, String imageURL, String courseShortDescription, String description, int totalEnrollment) {
